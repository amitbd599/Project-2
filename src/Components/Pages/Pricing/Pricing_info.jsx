...
const Pricing_info = () => {
  ...
  return (
    <>
    <Container className="price_info">
      <Row>
        <Col>
          <div className="wrap text-center">
            <h3 className="fs-20 fw-bold theme-primary-color">PRICING PLAN</h3>
      ...
      <Row>
        <Col>
          ...
          <span className={active ? null : 'theme-primary-color'}>
            ...
            <span
              className={
                active ? "pricing-tab-switcher active" : "pricing-tab-switcher"
              }
    ...
    <Container fluid className="Service_Price_plan pricing  ">
    <Container>
      ...
      <Row className="part_2  pb-80">
        <Col md={4} className="pb-50">
          <div className="wrap">
            <div className="text-center">
              <h2 className="fs-40 fw-bold theme-primary-color">{active? "$ 30" : "$ 0"}</h2>
              <h3 className="fs-20 mt-15 fw-bold">BASIC ACCOUNT</h3>
              <p className="mt-10">{active?  'Only for one year' : 'Only for first month'}</p>
            </div>
            <br />
        ...
        <Col md={4} className="pb-50">
          <div className="wrap">
            <div className="text-center">
              <h2 className="fs-40 fw-bold theme-primary-color">{active? "$ 250" : "$ 20"}</h2>
        ...
        <Col md={4} className="pb-50">
          <div className="wrap">
            <div className="text-center">
              <h2 className="fs-40 fw-bold theme-primary-color">{active? "$ 350" : "$ 60"}</h2>
